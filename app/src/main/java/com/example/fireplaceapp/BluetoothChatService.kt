...
class BluetoothChatService(context: Context, handler: Handler){
    ...
    private val MY_UUID_SECURE = UUID.fromString("29621b37-e817-485a-a258-52da5261421a") //TODO
    private val MY_UUID_INSECURE = UUID.fromString("d620cd2b-e0a4-435b-b02e-40324d57195b") //TODO
    ...
    @Synchronized fun connected(socket: BluetoothSocket?, device: BluetoothDevice?, socketType: String) {
        ...
        val msg = mHandler?.obtainMessage(Constants.MESSAGE_DEVICE_NAME) // TODO: ???
        val bundle = Bundle()
    ...
    private fun connectionFailed() {
        ...
        if (msg != null) {
            ...
            Log.d(TAG, "connectionFailed - msg is null")
        }
    ...
    private fun connectionLost() {
        ...
        if (msg != null) {
            ...
            Log.d(TAG, "connectionLost - msg is null")
        }
